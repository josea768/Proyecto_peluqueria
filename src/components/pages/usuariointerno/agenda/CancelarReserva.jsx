            ...
            <tr key={index} class="table-active">
                ...
                <td>
                    <div className="d-inline-flex">
                        <button type="button" className="btn btn-danger"value="Cancelar">
                            Cancelar
                        </button>
                    </div>
                </td>
    ...
    return (<div>
        <div class="d-flex justify-content-center align-items-center">
            <ul class="nav nav-tabs">
                ...
                <li className="nav-item">
                    <Link className="nav-link active" to='/CancelarReserva' aria-aria-current="page">Cancelar Reserva</Link>
                </li>
            </ul>
        </div>
